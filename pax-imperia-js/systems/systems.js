...
import { GameStateInterface } from '/script/gameStateInterface/gameStateInterface.js';
...
let gameStateInterface = new GameStateInterface({ galaxy: galaxy });
...
await spaceViewWidget.loadWidget(0);
